...
(() => {
  const registry = Object.freeze([
    ...
    { zoneKey: 'ZONE_03', x: -16, z: -9, scale: .80, family: 'HOUSE' },
    { zoneKey: 'ZONE_04', x: -12, z: -9, scale: .70, family: 'HOUSE' },
    { zoneKey: 'ZONE_05', x: -8, z: -7, scale: .78, family: 'HOUSE' },
    { zoneKey: 'ZONE_06', x: -4, z: -9, scale: .70, family: 'HOUSE' },
    { zoneKey: 'ZONE_07', x: 5, z: -9, scale: .78, family: 'HOUSE' },
    { zoneKey: 'ZONE_08', x: 9, z: -10, scale: .68, family: 'HOUSE' },
    { zoneKey: 'ZONE_09', x: 15, z: -9, scale: .78, family: 'HOUSE' },
    { zoneKey: 'ZONE_10', x: 17, z: -5, scale: .70, family: 'HOUSE' },
    { zoneKey: 'ZONE_11', x: -17, z: -3, scale: .68, family: 'HOUSE' },
    { zoneKey: 'ZONE_12', x: -13, z: -1, scale: .82, family: 'HOUSE' },
    { zoneKey: 'ZONE_13', x: -8, z: -2, scale: .72, family: 'HOUSE' },
    { zoneKey: 'ZONE_14', x: -4, z: -4, scale: .66, family: 'HOUSE' },
    { zoneKey: 'ZONE_15', x: 5, z: -3, scale: .70, family: 'HOUSE' },
    { zoneKey: 'ZONE_16', x: 9, z: -2, scale: .78, family: 'HOUSE' },
    { zoneKey: 'ZONE_17', x: 15, z: -1, scale: .70, family: 'HOUSE' },
    { zoneKey: 'ZONE_18', x: 17, z: 3, scale: .72, family: 'HOUSE' },
    { zoneKey: 'ZONE_19', x: -16, z: 5, scale: .75, family: 'HOUSE' },
    { zoneKey: 'ZONE_20', x: -13, z: 9, scale: .68, family: 'HOUSE' },
    { zoneKey: 'ZONE_21', x: -7, z: 8, scale: .75, family: 'HOUSE' },
    { zoneKey: 'ZONE_22', x: -3, z: 6, scale: .65, family: 'HOUSE' },
    { zoneKey: 'ZONE_23', x: 5, z: 7, scale: .72, family: 'HOUSE' },
    { zoneKey: 'ZONE_24', x: 9, z: 9, scale: .78, family: 'HOUSE' },
    { zoneKey: 'ZONE_25', x: 14, z: 8, scale: .67, family: 'HOUSE' },
    { zoneKey: 'ZONE_26', x: 17, z: 6, scale: .72, family: 'HOUSE' }
  ]);
