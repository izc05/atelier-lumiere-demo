...
-- Conserva la regla introducida en 0023: el taller puede emitir y revisar
-- un presupuesto, pero solo el cliente propietario puede aprobarlo.
-- Se mantiene además la inserción mínima del servicio de checkout piloto.
