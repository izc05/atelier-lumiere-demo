...
assert.match(service, /updated_at = \$8::timestamptz/);
assert.match(service, /updated_at = \$6::timestamptz/);
...
assert.match(providerJs, /expectedUpdatedAt: shipment\.updatedAt/);
assert.match(providerJs, /expectedUpdatedAt: incident\.updatedAt/);
...
assert.match(apiTest, /sin cruces/);
